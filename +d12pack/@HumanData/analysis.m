...
MedianWakingIlluminance       = vertcat(obj.MedianWakingIlluminance);
MedianWakingCircadianLight    = vertcat(obj.MedianWakingCircadianLight);
MedianWakingCircadianStimulus = vertcat(obj.MedianWakingCircadianStimulus);
...
MedianAtWorkIlluminance       = vertcat(obj.MedianAtWorkIlluminance);
MedianAtWorkCircadianLight    = vertcat(obj.MedianAtWorkCircadianLight);
MedianAtWorkCircadianStimulus = vertcat(obj.MedianAtWorkCircadianStimulus);
...
MedianPreWorkIlluminance       = vertcat(obj.MedianPreWorkIlluminance);
MedianPreWorkCircadianLight    = vertcat(obj.MedianPreWorkCircadianLight);
MedianPreWorkCircadianStimulus = vertcat(obj.MedianPreWorkCircadianStimulus);
...
MedianPostWorkIlluminance       = vertcat(obj.MedianPostWorkIlluminance);
MedianPostWorkCircadianLight    = vertcat(obj.MedianPostWorkCircadianLight);
MedianPostWorkCircadianStimulus = vertcat(obj.MedianPostWorkCircadianStimulus);
...
VariableNames = {...
    ...
    'Median_Waking_Illuminance',...
    'Median_Waking_Circadian_Light',...
    'Median_Waking_Circadian_Stimulus',...
    ...
    'Section_Break_3',...
    ...
    ...
    'Median_At_Work_Illuminance',...
    'Median_At_Work_Circadian_Light',...
    'Median_At_Work_Circadian_Stimulus',...
    ...
    'Section_Break_4',...
    ...
    ...
    'Median_Pre_Work_Illuminance',...
    'Median_Pre_Work_Circadian_Light',...
    'Median_Pre_Work_Circadian_Stimulus',...
    ...
    'Section_Break_5',...
    ...
    ...
    'Median_Post_Work_Illuminance',...
    'Median_Post_Work_Circadian_Light',...
    'Median_Post_Work_Circadian_Stimulus'};
...
t = table(...
    ...
    MedianWakingIlluminance,...
    MedianWakingCircadianLight,...
    MedianWakingCircadianStimulus,...
    ...
    sectionBreak,...
    ...
    AtWorkCoverage,...
    ...
    MedianAtWorkIlluminance,...
    MedianAtWorkCircadianLight,...
    MedianAtWorkCircadianStimulus,...
    ...
    sectionBreak,...
    ...
    PreWorkCoverage,...
    ...
    MedianPreWorkIlluminance,...
    MedianPreWorkCircadianLight,...
    MedianPreWorkCircadianStimulus,...
    ...
    sectionBreak,...
    ...
    PostWorkCoverage,...
    ...
    MedianPostWorkIlluminance,...
    MedianPostWorkCircadianLight,...
    MedianPostWorkCircadianStimulus,...
    ...
