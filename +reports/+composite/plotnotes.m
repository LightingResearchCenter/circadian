function plotnotes(Phasor,Actigraphy,Average,position,units)
...
label1 = {...
        ...
        'Intradaily Variability (IV):';...
                                    '';...
                      'Mean Activity:';...
	   'Mean Circadian Stimulus (CS):';...
'Geometric Mean Photopic Illuminance:';};
   
data1 = {...
    num2str(Phasor.magnitude, precision);...
    num2str(Phasor.angle.hours, precision);...
    '';...
    num2str(Actigraphy.interdailyStability, precision);...
    num2str(Actigraphy.intradailyVariability, precision);...
    '';...
    num2str(Average.activity.arithmeticMean, precision);...
	num2str(Average.cs.arithmeticMean, precision);...
    num2str(Average.illuminance.geometricMean, precision)};
